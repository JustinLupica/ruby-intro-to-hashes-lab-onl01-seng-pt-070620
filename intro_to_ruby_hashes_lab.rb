...
def monopoly_with_fourth_tier
	monopoly = {railroads: {pieces: 4, names: {reading_railroad: {"mortgage value" => "$100"}, pennsylvania_railroad: {}, b_and_o_railroad: {}, shortline: {}}, rent_in_dollars: {one_piece_owned: 25, two_pieces_owned: 50, three_pieces_owned: 100, four_pieces_owned: 200}}}
